...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // service_4wf6ysu', 'template_dxt1z7q', updatedFormData, 'mTn6W1SnND7UaTmyN'
    emailjs.send('service_sqdxv7s', 'service_sqdxv7s', updatedFormData, 'fjrMc5_WnIvQiV9Ic')
      .then((result) => {
      ...
      <div>
        <form onSubmit={handleSubmit}>
          ...
          <input
            type="email"
            name="email"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 mb-4"
